...
use Drupal\appointment_booking\AgencyInterface;
use Drupal\appointment_booking\AgencyListBuilder;
use Drupal\appointment_booking\Form\AgencyForm;
...
#[ContentEntityType(
  ...
  links: [
    ...
    'add-form' => '/admin/content/agencies/add',
    'canonical' => '/admin/content/agencies/{agency}',
    'edit-form' => '/admin/content/agencies/{agency}/edit',
    'delete-form' => '/admin/content/agencies/{agency}/delete',
