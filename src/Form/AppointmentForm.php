  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('appointment_booking')->notice('New appointment %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The appointment %label has been updated.', $message_args));
        $this->logger('appointment_booking')->notice('The appointment %label has been updated.', $logger_args);
        break;
